...
// We don't need CSRF for this example
      /*  httpSecurity.csrf().disable()
        ...
        httpSecurity.csrf().disable()
                .authorizeRequests()
                /* .antMatchers("/geography/**").authenticated()
                 .antMatchers("/transaction-report/**").authenticated()*/
                .antMatchers("/authenticate", "/register").permitAll()
                .anyRequest().authenticated()
                .and()
                .addFilterBefore(new JwtRequestFilter(), BasicAuthenticationFilter.class)
                .addFilterAfter(new ApiAuthorizationFilter(authenticationManager()), JwtRequestFilter.class).
